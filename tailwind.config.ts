  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-verified": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(162 63% 41% / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(162 63% 41% / 0)" },
        },
      },
      animation: {
        ...
        "pulse-verified": "pulse-verified 2s ease-in-out infinite",
      },
      fontFamily: {
